...
namespace FoodApp.CustomViews
{
    public class FacebookLoginButton : View
    {
        ...
        public static readonly BindableProperty PermissionsProperty = BindableProperty.Create(nameof(Permissions), typeof(string[]), typeof(FacebookLoginButton), defaultValue: new string[] { "public_profile", "email" });
