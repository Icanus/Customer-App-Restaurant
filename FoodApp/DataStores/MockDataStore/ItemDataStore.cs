...
namespace FoodApp.DataStores.MockDataStore
{
    ...
    //    }
    //    /*
    //    async Task<IList<Item>> InitializeData()
    //    {
    //        var resultAllItems = await JsonWebApiAction.GetAllItems();
    //        Console.WriteLine(resultAllItems);
    //        List<Item> list = new List<Item>();
    //        foreach (var item in resultAllItems)
    //        {
    //            Item itm = new Item();
    //            itm.Id = item.ItemId;
    //            itm.Name = item.Name;
    ...
    //            itm.RegularPrice = item.RegularPrice;
    //            itm.IsPopular = item.IsPopular;
    //            itm.IsFavorite = item.IsFavorite;
    //            itm.IsFeatured = item.IsFeatured;
    //            if(item.CategoryId == 1)
    //            {
    //                itm.Choices = new List<Choice<ChoiceItem>>()
    //                {
    //                    new Choice<ChoiceItem>("Ingredients", new List<ChoiceItem>
    //                    {
    //                        new IngredientItem("Onion"),
